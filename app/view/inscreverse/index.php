...
$tag->html();
	$tag->head();
	    ...
	    $tag->meta('name="description" content="' . $language->SUBSCRIBE_META_DESCRIPTION . '"');
        $tag->meta('name="keywords" content="' . $language->SUBSCRIBE_META_KEYWORDS . '"');
	    ...
	    $tag->title();
	    	$tag->printer($language->SUBSCRIBE_TITLE);
	    $tag->title;
	    // <!-- Favicon-->
