<div role="tabpanel" class="tab-pane fade" id="itens">
    <br>
    <div class="row">
    	<?php foreach ($utilitarios->itens as $key => $value) { ?>
	            ...
	            <div class="thumbnail">
	                ...
	                <div class="caption">
	                    ...
	                    <div class="center demo-google-material-icon"> 
		                    ...
		                    <a href="#" data-toggle="modal" data-target="#itens_<?php echo $key; ?>">
...
<!-- Large Size -->
<?php foreach ($utilitarios->itens as $key => $value) { ?>
	<div class="modal fade" id="itens_<?php echo $key; ?>" tabindex="-1" role="dialog">
