<div role="tabpanel" class="tab-pane fade active in" id="helprpg">
	<br>
    <div class="row">
    	<?php foreach ($helprpg as $key => $value) { ?>
	            ...
	            <div class="thumbnail">
	                ...
	                <div class="caption">
	                    ...
	                    <div class="center demo-google-material-icon"> 
	                    	<a href="<?php echo URL_BASE.$value['APP_LINK']; ?>" target="blank">
		                    	<i class="material-icons">launch</i>
		                    </a>
		                    <a href="#" data-toggle="modal" data-target="#helprpg_<?php echo $key; ?>">
...
<!-- Large Size -->
<?php foreach ($helprpg as $key => $value) { ?>
	<div class="modal fade" id="helprpg_<?php echo $key; ?>" tabindex="-1" role="dialog">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	                <a href="<?php echo URL_BASE.$value['APP_LINK']; ?>" class="btn btn-link waves-effect">VISITAR FERRAMENTA</a>
