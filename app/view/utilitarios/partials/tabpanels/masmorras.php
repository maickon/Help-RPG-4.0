<div role="tabpanel" class="tab-pane fade" id="masmorras">
    <br>
    <div class="row">
    	<?php foreach ($utilitarios->masmorras as $key => $value) { ?>
	            ...
	            <div class="thumbnail">
	                ...
	                <div class="caption">
	                    ...
	                    <div class="center demo-google-material-icon"> 
		                    ...
		                    <a href="#" data-toggle="modal" data-target="#masmorras_<?php echo $key; ?>">
