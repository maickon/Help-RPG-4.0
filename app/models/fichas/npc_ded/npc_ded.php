...
class Personagem{
	...
	function construtor_montado($nivel='', $raca='', $classe='', $tipo='', $sexo='', $nome='', $player_nome, $cabelos='', $olhos='', $pele='',
		...
		if($atributos == true):
			...
			if($tipo == 'normal'):
				$this->gerar_habilidades_pts();
			elseif($tipo == 'forte'):	
				$this->gerar_habilidades_apelonas('forte');
			elseif($tipo == 'brutal'):
				$this->gerar_habilidades_apelonas('brutal');
			else:
				$this->escolher_padrao_de_habilidades();
			endif;
		endif;
		...
		if(empty($itens) && empty($armas) && empty($equipamento) && empty($armadura)):
			$this->equipamentos($this->classe, $this->nivel);
		else:
			$this->itens = $itens;
			$this->armas = $armas;
	...
	function escolher_padrao_de_habilidades(){
		...
		if($escolido <=10):
			$this->gerar_habilidades_pts();
		elseif($escolido > 10 && $escolido <=12):
			$this->gerar_habilidades_apelonas('forte');
		else:
			$this->gerar_habilidades_apelonas('brutal');	
		endif;
	...
	function gerar_habilidades_apelonas($modo){
		switch($modo):
			case 'forte':
				if($this->classe == 'barbaro' || $this->classe == 'barbara'):
					$this->for_ = rand(16,26);
					$this->con_ = rand(16,26);
					$this->des_ = rand(16,26);
					$this->int_ = rand(10,18);
					$this->sab_ = rand(10,18);
					$this->car_ = rand(10,18);
				elseif($this->classe == 'guerreiro' || $this->classe == 'guerreira'):
					$this->for_ = rand(16,24);
					$this->con_ = rand(16,24);
					$this->des_ = rand(16,26);
					$this->int_ = rand(12,18);
					$this->sab_ = rand(10,18);
					$this->car_ = rand(10,18);
				elseif($this->classe == 'paladino' || $this->classe == 'paladina'):
					...
					$this->des_ = rand(16,26);
					$this->int_ = rand(12,18);
					$this->sab_ = rand(12,18);
					$this->car_ = rand(18,26);
				elseif($this->classe == 'monge'):
					$this->for_ = rand(16,20);
					$this->con_ = rand(16,22);
					$this->des_ = rand(18,26);
					$this->int_ = rand(12,16);
					$this->sab_ = rand(18,26);
					$this->car_ = rand(12,18);
				elseif($this->classe == 'ladino' || $this->classe == 'ladina'):
					$this->for_ = rand(12,18);
					$this->con_ = rand(16,20);
					$this->des_ = rand(18,26);
					$this->int_ = rand(18,26);
					$this->sab_ = rand(12,16);
					$this->car_ = rand(12,18);
				elseif($this->classe == 'clerigo' || $this->classe == 'cleriga'):
					$this->for_ = rand(10,16);
					$this->con_ = rand(16,22);
					$this->des_ = rand(18,26);
					$this->int_ = rand(14,20);
					$this->sab_ = rand(18,26);
					$this->car_ = rand(14,22);
				elseif($this->classe == 'bardo'):
					$this->for_ = rand(10,16);
					$this->con_ = rand(14,20);
					$this->des_ = rand(14,20);
					$this->int_ = rand(14,20);
					$this->sab_ = rand(18,26);
					$this->car_ = rand(18,26);
				elseif($this->classe == 'feiticeiro' || $this->classe == 'feiticeira'):
					$this->for_ = rand(10,14);
					$this->con_ = rand(18,26);
					$this->des_ = rand(14,20);
					$this->int_ = rand(14,20);
					$this->sab_ = rand(14,20);
					$this->car_ = rand(18,26);
				...
				elseif($this->classe == 'ranger'):
					$this->for_ = rand(18,26);
					$this->con_ = rand(16,22);
					$this->des_ = rand(16,22);
					$this->int_ = rand(14,16);
					$this->sab_ = rand(10,18);
					$this->car_ = rand(10,18);
				endif;
			break;
			...
			case 'brutal':
				if($this->classe == 'barbaro' || $this->classe == 'barbara'):
					$this->for_ = rand(20,60);
					$this->con_ = rand(20,60);
					$this->des_ = rand(20,40);
					$this->int_ = rand(10,18);
					$this->sab_ = rand(10,18);
					$this->car_ = rand(10,18);
				elseif($this->classe == 'guerreiro' || $this->classe == 'guerreira'):
					$this->for_ = rand(20,40);
					$this->con_ = rand(20,40);
					$this->des_ = rand(20,40);
					$this->int_ = rand(14,22);
					$this->sab_ = rand(12,20);
					$this->car_ = rand(12,20);
				elseif($this->classe == 'paladino' || $this->classe == 'paladina'):
					$this->for_ = rand(20,40);
					$this->con_ = rand(20,40);
					$this->des_ = rand(20,40);
					$this->int_ = rand(10,18);
					$this->sab_ = rand(18,30);
					$this->car_ = rand(18,30);
				elseif($this->classe == 'monge'):
					$this->for_ = rand(20,40);
					$this->con_ = rand(20,40);
					$this->des_ = rand(20,60);
					$this->int_ = rand(14,18);
					$this->sab_ = rand(20,60);
					$this->car_ = rand(18,30);
				elseif($this->classe == 'ladino' || $this->classe == 'ladina'):
					$this->for_ = rand(20,30);
					$this->con_ = rand(20,40);
					$this->des_ = rand(20,60);
					$this->int_ = rand(20,30);
					$this->sab_ = rand(20,30);
					$this->car_ = rand(18,30);
				elseif($this->classe == 'clerigo' || $this->classe == 'cleriga'):
					$this->for_ = rand(18,30);
					$this->con_ = rand(18,30);
					$this->des_ = rand(18,30);
					$this->int_ = rand(20,30);
					$this->sab_ = rand(20,60);
					$this->car_ = rand(20,30);
				elseif($this->classe == 'bardo'):
					$this->for_ = rand(18,26);
					$this->con_ = rand(18,26);
					$this->des_ = rand(18,26);
					$this->int_ = rand(18,30);
					$this->sab_ = rand(20,50);
					$this->car_ = rand(20,60);
				elseif($this->classe == 'feiticeiro' || $this->classe == 'feiticeira'):
					$this->for_ = rand(18,26);
					$this->con_ = rand(18,26);
					$this->des_ = rand(18,26);
					...
					$this->car_ = rand(20,60);
				elseif($this->classe == 'mago' || $this->classe == 'maga'):
					$this->for_ = rand(18,20);
					$this->con_ = rand(18,20);
					$this->des_ = rand(18,20);
					$this->int_ = rand(20,60);
					$this->sab_ = rand(20,50);
					$this->car_ = rand(18,50);
				elseif($this->classe == 'druida'):
					$this->for_ = rand(18,26);
					$this->con_ = rand(18,26);
					$this->des_ = rand(18,26);
	...
	function equipamentos($classe, $nivel){
			...
			elseif($classe == 'paladino' || $classe == 'paladina'):
					$this->armadura = "Brunea (+4 CA, -6 de penalidade de armadura, 6 m de deslocamento, 15 kg).
									  Escudo grande de madeira (+2 CA, -2 de penalidade de armadura, 5 kg).";
					$this->armas = "Espada longa (1d8, dec. 19-20/x 2, 2 kg, uma mão, cortante).
									Arco Curto (1d6, dec.x 3,18 m, 1 kg, perfurante)";
					$this->equipamento = "Mochila com cantil, um dia de rações de viagem, saco de dormir,
		...
		switch($nivel):
			...
			case 11: $this->riqueza = rand(0,9000);
					$this->itens = "Alguma arma corpo-a-corpo ou a distância +3 ou armadura mágica +3, algum item que da +2 nos Testes de resistência ou +2 na CA, ou em uma 				das habilidades básica.(for,des,con...).";		
			break;
			...
			case 18: $this->riqueza = rand(0,35.000);
					$this->itens = "Alguma arma corpo-a-corpo ou a distância +5 ou armadura mágica +5, 
									algum item que da +5 nos Testes de resistência ou +5 na CA, ou +6 em uma das habilidades básica.(for,des,con...) ou em alguma pericia.
	...
	function divindade($tendencia=''){
		$escolido = rand(0,1);
		if($escolido == 0):
			$this->divindade = "Sem divindade";
			$this->religiao = "Sem religião";
		else:
			switch($tendencia):
				case 'bom':	$deuses_bons = array("Bast","Hátor","Imhotep","Ísis","Neftis","Osíris","Balder","Heimdall","Njord",
									 "Odur","Sif","Thor","Zeus","Afrodite","Apolo","Ártemis","Atena","Hefestos","Hera",
				...
				break;
				case 'mau':	$deuses_maus = array("Apep","Set","Sobek","Aegir","Hel","Loki","Surtur","Thrym","Ares","Hades","Hécate",
				...
				break;
				case 'neutro': $deuses_neutro = array("Deméter","Dionísio","Nike","Pã","Posseiodon","Tique","Rá-Heru-cuti","Anúbis",
										"Bast","Bes","Ptah","Ser","Toth","Forseti","Frigga","Hermod","Skadi","Tyr","Uller",
										"Akamarah","Soudath","Randon","Sizax","Óprimum","Oclast","Pazmonn","Totris","Valcnx","Ermax"
										);	
									$escolido = rand(0,count($deuses_neutro)-1);
									$this->divindade = $deuses_neutro[$escolido];
									$this->religiao = "Neutra";
				break; 
				case 'todos': $todos_os_deuses = array("Bast","Hátor","Imhotep","Ísis","Neftis","Osíris","Balder","Heimdall","Njord",
									 "Odur","Sif","Thor","Zeus","Afrodite","Apolo","Ártemis","Atena","Hefestos","Hera",
									 "Hécules","Hermes","Héstia","Odin","Frey","Freya",
									 "Emprettamux","Dozenix","Auros","Tomoskax","Zelis","Mix","Times","Pelos","Orkom","Zordom",
									 "Deméter","Dionísio","Nike","Pã","Posseiodon","Tique","Rá-Heru-cuti","Anúbis",
									 "Bast","Bes","Ptah","Ser","Toth","Forseti","Frigga","Hermod","Skadi","Tyr","Uller",
									 "Akamarah","Soudath","Randon","Sizax","Óprimum","Oclast","Pazmonn","Totris","Valcnx","Ermax",
									 "Apep","Set","Sobek","Aegir","Hel","Loki","Surtur","Thrym","Ares","Hades","Hécate",
									 "Erk-Crux","Tombskox","Ocrom","Terzenax","Mefilix","Omprimium","Zolkax","Propmatux","Ortazer","MokxZilix");
